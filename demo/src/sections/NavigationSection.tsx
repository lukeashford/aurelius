      ...
      >
        <div className="space-y-8">
          ...
          <Card className="p-6 space-y-4">
            <h3 className="text-gold font-medium">Navbar</h3>
            <p className="text-sm text-silver">
              Responsive navigation bar with brand, links, and actions.
            </p>
            <div className="bg-graphite -mx-6 -mb-6 mt-4 p-0">
              <Navbar>
                <NavbarBrand>
                  <span className="font-heading text-lg text-gold">Aurelius</span>
                </NavbarBrand>
                <NavbarContent>
                  <NavbarItem>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <Card className="p-6 space-y-4">
              ...
              <Accordion type="single" defaultValue="item-1">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    Aurelius is a cohesive design system combining technical
                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent>
                    Install the package via npm and import the components you
                    need. Check the documentation for detailed examples.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-3">
                  <AccordionTrigger>Is it customizable?</AccordionTrigger>
                  <AccordionContent>
                    Yes! Aurelius is built on Tailwind CSS v4 and supports full
            ...
            <Card className="p-6 space-y-4">
              ...
              <div className="flex gap-4">
                <Menu>
                  <MenuTrigger
                      className="inline-flex items-center gap-2 px-4 py-2 bg-charcoal border border-ash text-white hover:border-gold transition-colors">
